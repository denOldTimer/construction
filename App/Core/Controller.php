...
abstract class Controller
{
	...
	protected static function getScVariables()
	{
		 ...
		 if (!empty($variables)){
			...
			throw new \Exception("Controller.php : getScVariables : Array is empty:".$variables );
	}
	protected static function getScMeta()
	{
		 $meta = Meta::getMeta();
		 if (!empty($meta)){
			 return $meta;
			...
			throw new \Exception("Controller.php : getScMeta : Array is empty:".$meta );
     ...
     * @return object $data
     */
	protected static function getTranslation($lang)
	{
